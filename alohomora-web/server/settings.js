...
var getMaxMemoryCost = () => math.floor(math.log(os.totalmem() / 1024, 2));
...
var settings = {
    ...
    argon2: {
        ...
        memoryCost: getMaxMemoryCost() - 4, // 1/8 of Max memory , be careful as this is already a high default value.
